	...
	<div class="col-lg-12">
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				?>
					<tr>
						<th scope="row"><a class="bulleNum" href="../programme-<?= $program['programUrl'] ?>-<?= $program['id'] ?>-<?= $program['id_section'] ?>" target="_blank"><?= $program['id'] ?></a></th>
						<th scope="row"><a class="bulleNum" href="../section-<?= $program['sectionUrl'] ?>-<?= $program['id_section'] ?>" target="_blank"><?= $program['id_section'] ?></a></th>
						<th><?= $program['name'] ?></th>
