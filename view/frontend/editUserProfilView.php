		...
		<div class="row">
			<div class="offset-lg-2 col-lg-8">
				...
				<div class="row" id="editPassword">
					<form action="index.php?action=editPw" method="post"  class="col-lg-12">
				...
				<div class="row" id="editInsta">
					<form action="index.php?action=editInsta" method="post"  class="col-lg-12">
						<?php
						if (!empty($user['instagram']))
						{
						?>
				...
				<div class="row" id="editMail">
					<form action="index.php?action=editMail" method="post"  class="col-lg-12">
				...
				<div class="row" id="editCity">
					<form action="index.php?action=editCity" method="post"  class="col-lg-12">
