			...
			<div class="offset-lg-1 col-lg-10 formMap" id="formMapHome">
				<form action='index.php?action=map' method='post'>
					...
					<div class="form-group row">
						<input type="text" name="search" id="search" class="form-control" placeholder="Adresse, Ville CP">
...
<div class="container contenant">
	<div class="row">
		<div class="col-lg-4 homeSection">
			<div class="row">
				<div class="pictSection"></div>
			</div>
			<div class="row">
				<h5 class="offset-lg-3">Nos programmes :</h5>
			</div>
			<div class="row">
				<p class="offset-lg-1 col-lg-10">Varie tes scéances en utilisant nos divers programmes.</p>
			</div>
			<div class="row">
				<a href="index.php?action=section" class="btn btn-dark offset-lg-7 col-lg-4"><i class="fas fa-plus-circle"></i>  Accéder</a>
			</div>
			
		</div>
		<div class="offset-lg-4 col-lg-4 homeJoin">
			<div class="row">
				<div class="pictJoin"></div>
			</div>
			<div class="row">
				<h5 class="offset-lg-3">Rejoins-nous :</h5>
			</div>
			<div class="row">
			...
			<div class="row">
				<a href="index.php?action=feedInsta" class="btn btn-dark offset-lg-7 col-lg-4"><i class="fas fa-plus-circle"></i>  Accéder</a>
			</div>
		</div>
	</div>
</div>
